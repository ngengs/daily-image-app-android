...
object DataForger {
    ...
    inline fun <reified T : Serializable> forgeSerializable(
        ...
        return internalForgeClass(instance, instance.javaClass.declaredFields, forgeOption, forger)
    }
    ...
    private fun createSerializableData(clz: Class<*>, option: ForgeOption, forger: Forge): Serializable {
